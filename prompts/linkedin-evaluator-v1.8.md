...
**Version:** 1.8
**Updated:** 2026-03-02
**New in v1.8:** Recommenders who are Flutter/mobile developers are evaluated as potential candidate leads and returned in a separate `referral_candidates` array.
...
4. Visit EVERY recommender profile — not just Flutter ones
...
1. Full evaluation of the candidate whose URL was in your input
...
## STEP 1: Visit and Unfurl All Profile Sections

Visit the URL from your INPUT. Expand every collapsed section:
- Headline, About (click see more), Featured, ALL Experience entries (click see more on each), Education, Skills, ALL Recommendations (scroll to bottom), Projects
...
Scroll to the bottom of the profile and read ALL recommendations.
...
VISIT THE URL FROM YOUR INPUT. STEP 0 contractor check runs FIRST.
